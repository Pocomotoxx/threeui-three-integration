...
import { ThreejsHub } from "./components/ThreejsHub";
...
type AppPage = "shader" | "browse" | "installation" | "mcp" | "threejs" | "not-found";
...
function ThreeUIApp() {
  ...
  const selectThreejs = () => {
    setRouteState((current) => ({ ...current, page: "threejs", canonicalPath: STATIC_ROUTE_PATHS.threejs }));
    setSidebarOpen(false);
    window.history.pushState({}, "", navigationUrl(STATIC_ROUTE_PATHS.threejs));
  };
