...
export function Sidebar({ active, browseActive, installationActive, mcpActive, threejsActive, open, theme, palette, onSelect, onBrowse, onInstallation, onMcp, onThreejs, onPricing, onSearch, onTheme }: SidebarProps) {
        ...
        <nav className="sb-nav" aria-label="ThreeUI documentation">
          <div className="nav-section">
            ...
            <div className="nav-list nav-list-root">
              ...
              <button
                className={`nav-link${threejsActive ? " active" : ""}`}
                aria-current={threejsActive ? "page" : undefined}
                onClick={onThreejs}
              >
